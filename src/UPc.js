...
const UPc = props => {
   ...
   /* const handleFileSubmit = () => {
    ...
    return (
        <>
            <div className="flex flex-wrap justify-center  w-full bg-gray-200-200 mt-4">
                <div 
                    ref={wrapperRef}
                    className="relative w-80 h-80 border-2 border-dashed border-gray-300 rounded-lg bg-gray-100 hover:opacity-60 focus:opacity-60  p-4 mx-2"
                    style={{ zIndex: 0 }}
                ...
                {
                    fileList.length > 0 ? (
                        <div className="w-1/4  p-4 mx-2">
                            <p className="text-xl font-bold mb-2">Uploaded Files</p>
                            {
                                fileList.map((item, index) => (
                                    <div key={index} className="flex items-center mb-2 rounded-lg bg-gray-100 p-2">
